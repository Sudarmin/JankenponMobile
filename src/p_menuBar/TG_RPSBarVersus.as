package p_menuBar
{
	...
	public class TG_RPSBarVersus extends TG_MenuBar
	{
		...
		private var m_align:String = "left";
		
		public function TG_RPSBarVersus(parent:DisplayObjectContainer, gameState:TG_GameState, align:String)
		{
			m_align = align;
		...
		protected override function initSprite():void
		{
			...
			m_rockText = new TextField(100,70,str,"Londrina",50,0x00FFFF);
			...
			m_paperText = new TextField(100,70,str,"Londrina",50,0x00FFFF);
			...
			m_scissorText = new TextField(100,70,str,"Londrina",50,0x00FFFF);
		...
		{
			super.resize();
			m_sprite.scaleX = m_sprite.scaleY = TG_World.SCALE_ROUNDED * 0.4;
			if(m_align == "left")
			{
				m_sprite.x = 10 * TG_World.SCALE_ROUNDED * 0.5;
			}
			else
			{
				m_sprite.x = (TG_World.GAME_WIDTH - m_sprite.width) - (10 * TG_World.SCALE_ROUNDED * 0.5);
			}
		...
		{
			m_gameState.doSomething("rockPressed"+m_align);
		}
		private function onPaperPressed(e:Event):void
		{
			m_gameState.doSomething("paperPressed"+m_align);
		}
		private function onScissorPressed(e:Event):void
		{
			m_gameState.doSomething("scissorPressed"+m_align);
		}
