package starling.extensions
{
	...
	public class Scale9Image extends Sprite
	{
		...
		public function Scale9Image(texture:Texture, centerRect:Rectangle,smoothing:Boolean = true)
		{
			_tW = texture.width;
			_tH = texture.height;
			_grid = centerRect;
			...
			if(!smoothing)
			{
				_tl.smoothing = TextureSmoothing.NONE;
				_tc.smoothing = TextureSmoothing.NONE;
				_tr.smoothing = TextureSmoothing.NONE;
				_cl.smoothing = TextureSmoothing.NONE;
				_cc.smoothing = TextureSmoothing.NONE;
				_cr.smoothing = TextureSmoothing.NONE;
				_bl.smoothing = TextureSmoothing.NONE;
				_bc.smoothing = TextureSmoothing.NONE;
				_br.smoothing = TextureSmoothing.NONE;
			}
