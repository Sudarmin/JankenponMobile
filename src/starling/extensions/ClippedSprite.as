package starling.extensions
{
    ...
    public class ClippedSprite extends Sprite
    {
        ...
        private var mClipRectOri:Rectangle;
		
		public var posReference:DisplayObject;
        ...
        public override function render(support:RenderSupport, alpha:Number):void
        {
            ...
            else
            {
				...
				mClipRect.x = (mClipRectOri.x * TG_World.stageScale) + posReference.x + parent.x;
				mClipRect.y = (mClipRectOri.y * TG_World.stageScale) + posReference.y + parent.y;
				mClipRect.width = mClipRectOri.width * TG_World.stageScale;
				mClipRect.height = mClipRectOri.height * TG_World.stageScale;
