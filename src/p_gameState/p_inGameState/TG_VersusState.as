package p_gameState.p_inGameState
{
	...
	public class TG_VersusState extends TG_InGameState
	{
		...
		private var m_question:TG_QuestionTypeB;
		...
		public function TG_VersusState(parent:DisplayObjectContainer)
		{
			super(parent);
		}
		...
		protected override function initMenuBars():void
		{
			...
			m_question = new TG_QuestionTypeB(m_sprite,this);
		...
		protected override function onStartTextCompleted():void
		{
			...
			if(m_question)
			{
				var rand:int = (Math.random() * 1000) % 2;
				if(rand == 0)
				{
					rand = 3;
				}
